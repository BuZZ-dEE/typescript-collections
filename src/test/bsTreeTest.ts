...
describe('Binary Search Tree', function () {
  ...
  let tree: collections.BSTree<T>;

  beforeEach(function () {
    tree = new collections.BSTree();
  });
  let createTree1 = function () {
    tree.add('b');
    tree.add('a');
    tree.add('c');
  };
  let createTree2 = function () {
    tree.add('f');
    tree.add('b');
    tree.add('a');
    tree.add('d');
